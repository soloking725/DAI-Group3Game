...
function main() {
  ...
  if (args.includes('--simulate')) {
    ...
    if (args.includes('--html')) {
      ...
      const fullDoc = `<!doctype html>\n<html><head><meta charset="utf-8"><title>Stillpoint — Playthrough Simulation</title><link rel="stylesheet" href="../styles/design-system.css"></head><body>\n${html}\n</body></html>\n`;
  ...
  if (args.includes('--html')) {
    ...
    const fullDoc = `<!doctype html>\n<html><head><meta charset="utf-8"><title>Stillpoint — Floor Plan Path Viewer</title><link rel="stylesheet" href="../styles/design-system.css"></head><body>\n${html}\n</body></html>\n`;
    fs.writeFileSync(outPath, fullDoc);
