...
flowchart TD
    ...
    Crag_Altar_unlocks_c_37825bdb --> Crag_Warden_miniboss_72af253f["Crag Warden<br>(miniboss)"]
    ...
    Echo_Bridge_part_1_m_99e4e301 --> Crystal_Cavern_unloc_04f4af71["Crystal Cavern<br>(unlocks Shard Shot)<br>(shard shot required to leave)"]
    ...
    Timeline_X_Roads_Roo_6da4d1dd --> Echo_Bridge_Prison_1_8f7c5e40["Echo Bridge, Prison<br>(1 cosmetic upgrade)<br>(if coming here from mandatory order from Echo Bridge, you cannot go to X Roads Room 1 or enter Mirror Corridor until you go to Timeline X Roads Room 2)"]
    Mirror_Veil_Hollow_m_991cd9fc --> Mirror_Veil_Sanctum__31d7793f["Mirror Veil, Sanctum<br>(unlocks Phase Dash)"]
    Mirror_Veil_Sanctum__31d7793f --> Mirror_Corridor_c9be7338[Mirror Corridor]
    ...
    Timeline_X_Roads_Roo_65253a78 -->|Graviton Surge and Phase Dash are required for this path| The_Rift_entry_requi_c828e742
    ...
    The_Rift_entry_requi_c828e742["The Rift<br>(entry requires Charged Attack)<br>(entry requires Graviton Surge)<br>(entry requires Stillpoint)<br>(entry requires child_choice_resolved)"] --> Polar_Shift_Room_1_f_dbd9a683
